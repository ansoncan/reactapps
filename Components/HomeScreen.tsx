...
//   const [searchResults, setSearchResults] = useState<Film[]>(null); // Changed to null to differentiate empty search
...
//     setSearchText(text);
//     setSearchResults(null); // Ensure results are null while typing
//   };
...
//       setSearchResults(null); // Handle errors by setting results to null
//     } finally {
...
//         onUserPress={() => navigation.navigate('LoginScreen')}
...
//         </View>
//       ) : isSearchActive && searchResults !== null ? ( // Show results only when they are not null
//         searchLoading ? (
//           <View style={styles.centered}>
//             <ActivityIndicator size="large" color="#4DA8DA" />
...
//         )
//       ) : filteredFilms.length > 0 ? ( // Fallback to filtered Films
